...
$where = ['1=1'];
$params = [];
if (in_array($role, ['student', 'teacher', 'registrar'], true)) {
    $where[] = 'u.role = ?';
    $params[] = $role;
}
if ($kw !== '') {
...
page_header('จัดการผู้ใช้', 'นักศึกษา อาจารย์ และเจ้าหน้าที่ฝ่ายทะเบียน',
    '<div class="dropdown"><button class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-person-plus me-1"></i>เพิ่มผู้ใช้</button>
     <ul class="dropdown-menu dropdown-menu-end">
        <li><a class="dropdown-item" href="/registrar/user/edit?role=student">นักศึกษา</a></li>
        <li><a class="dropdown-item" href="/registrar/user/edit?role=teacher">อาจารย์</a></li>
        <li><a class="dropdown-item" href="/registrar/user/edit?role=registrar">ฝ่ายทะเบียน</a></li>
     </ul></div>
...
<form class="row g-2 mb-3" method="get">
    ...
    <div class="col-md-4">
        <select name="role" class="form-select">
            ...
            <?php foreach (['student', 'teacher', 'registrar'] as $r): ?>
